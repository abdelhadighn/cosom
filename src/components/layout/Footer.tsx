      ...
      <div className="container grid gap-8 md:grid-cols-3">
        <div>
          ...
          <div className="flex space-x-4">
            <Link to="#" className="text-consom hover:text-consom-dark">
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li>
              <Link to="#" className="text-gray-600 hover:text-consom">Politique de confidentialité</Link>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <span className="text-gray-600">123 Rue du Commerce, 75000 Paris, France</span>
            </li>
            ...
            <li className="flex items-center">
              ...
              <span className="text-gray-600">contact@consom.fr</span>
            </li>
            <li className="flex items-center">
              <Clock className="h-5 w-5 text-consom mr-2 flex-shrink-0" />
              <span className="text-gray-600">Du lundi au samedi: 8h - 20h<br />Dimanche: 9h - 18h</span>
            </li>
          </ul>
        </div>
      </div>
